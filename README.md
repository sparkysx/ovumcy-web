...
Uses the prebuilt image from GHCR pinned to the latest tagged release by default (`ghcr.io/ovumcy/ovumcy-web:v1.1.0`).
...
```bash
OVUMCY_IMAGE=ghcr.io/ovumcy/ovumcy-web:v1.1.0 docker compose up -d
```
